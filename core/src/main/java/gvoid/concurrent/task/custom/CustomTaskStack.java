...
public class CustomTaskStack extends TaskStack {
    @Nullable
    ...
    public CustomTaskStack() {
        this(null, null, null);
    }

    public CustomTaskStack(@Nullable Handler handler,
                           @Nullable Handler postHandler) {
        this(handler, postHandler, null);
    }

    protected CustomTaskStack(@Nullable Handler handler,
                              @Nullable Handler postHandler,
    ...
    /* -------- Initialization -------- */
    @NonNull
    public static CustomTaskStack with(@Nullable Handler handler,
                                       @Nullable Handler postHandler) {
